...
export const BRAND_SIGNATURE = `> _By <a href="${FRONTEND_BASE}" target="_blank" rel="noopener noreferrer">BountyPay</a> <img src="${OG_ICON}" alt="BountyPay Icon" width="30" height="30" style="vertical-align: middle; margin-left: 6px;" />_`;
