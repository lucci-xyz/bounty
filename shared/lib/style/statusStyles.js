export const STAT_LABEL_CLASS =
  'mb-3 text-[11px] font-semibold uppercase tracking-[0.08em] text-muted-foreground/80';
export const STAT_VALUE_CLASS = 'text-[32px] font-light tracking-[-0.02em] text-foreground';
export const STAT_HINT_CLASS = 'text-sm font-light text-muted-foreground';
